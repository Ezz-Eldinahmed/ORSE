...
<div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
        ...
        <table class="min-w-full leading-normal">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <p class="text-gray-900 whitespace-no-wrap">{{$contact->message}}</p>
                    </td>

                    <td class="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                        <span class="relative inline-block px-3 py-1 font-semibold text-green-900 leading-tight">
                            <span aria-hidden class="absolute inset-0 bg-green-200 opacity-50 rounded-full"></span>
                            <span class="relative">{{$contact->created_at->diffForHumans()}}</span>
                        </span>
                    </td>
                ...
                @empty
                <p class="bg-purple-400 shadow-lg font-bold p-5 rounded m-5 text-white">No Contact Founded</p>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="px-5 py-5 bg-white border-t flex flex-col xs:flex-row items-center xs:justify-between">
        <x-Links-component :paginator=$contacts />
    </div>
</div>
